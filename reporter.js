...
function generateReport(jsonstr, automationHeader) {
    ...
    var result = '<html><head></head><script type="text/javascript" src="./jquery-3.2.1.min.js"></script><body background="./UID_BG.jpg"><div class="header">' + automationHeader + '</div>';
    ...
    for (var i = 0; i < resultq.length; i++) {
        ...
        //result += '<tr><td class="brk1"><b>' + tunique[i].toLowerCase(); + '</b></td></tr>';
        //var kk = unique.sort();
        var kk = unique;
...
function filewrite(result, outputFile) {
    result += "<style>";
    result += ".header{font-size: 38px;margin-bottom: 10px;margin-left: 150px; text-decoration: none;}";
    ...
    result += "table.hovertable td.testname{text-align:left;font-weight: 900;}";
    result += "table.hovertable td {border-width: 1px;padding: 8px;border-style: solid;border-color: #333333;text-align: center;font-weight: 900; font-size: 14px;}";
    result += "</style>";

    result += "<style> .newtable td, th { border: 3px solid #999;padding: 0.5rem; font-weight: 900;line-height: 24px;} </style> <script src=\"./table.js\"></script></body></html>";
