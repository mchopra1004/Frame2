...
describe('UIDS-892 Manage Second Factor Options of EMAIL & SMS in My Account ----- ', function() {
	...
	it(browser.tc_desc('UIDS-1761 TC1 (1) Verify elements of the page (2) When Email is added in 2FA'), function() {
		...
		expect(myactpage.twoStep.twoStepEmailsAdded.getText()).toContain(browser.params.user.authentication.secondFactorEmail);
	});

	it(browser.tc_desc('UIDS-1488 TC1 Verify (1) Zentry Logo (2) Copyright text on 2factor Email Details page'), function() {
...
it(browser.tc_desc('UIDS-1616 in UIDS-895 TC1 (1) Check presence of Help Button on my account 2factor details email'), function() {
...
it(browser.tc_desc('UIDS-1616 in UIDS-895 TC2 and TC3 (1) Click on help button on my account 2factor details email (2) Check the content'), function() {
...
it(browser.tc_desc('UIDS-1616 in UIDS-895 TC6 (1) Verify help menu is closed on my account 2factor details email (2) clicking on close button'), function() {
	...
	it(browser.tc_desc('UIDS-1367 Story TC1 (1) check Menu Link is clickable on my account 2 factor details email'), function() {
	...
	it(browser.tc_desc('UIDS-1367 Story TC2 (1) check Menu Items are available on my account 2 factor details email'), function() {
	...
	it(browser.tc_desc('UIDS-1367 Story TC3 (1) check Menu can be closed on my account 2 factor details email'), function() {
	...
	it(browser.tc_desc('UIDS-1677 TC 4a (1) Click on back button on my account 2factor details email (2) Verify user is redirected to my account page'), function() {
