...
describe('UIDS-889 Menu & Log out in My Account ----- ', function() {
	...
	it(browser.tc_desc('UIDS-1572 TC2 (1) Click on menu link (2) Observe the options available'), function() {
		...
		if (browser.params.langOption === 'en') {
			...
			if (browser.deviceName === 'Edge' || browser.deviceName === 'IE'){
				expect(homeP.footer.language.getText()).toMatch('\s*Language : English\s*');
			...
			else if (browser.deviceName === 'Chrome' || browser.deviceName === 'chrome' || browser.deviceName === 'Firefox'|| browser.deviceName === 'firefox') {

				expect(homeP.footer.language.getText()).toEqual('Language : English');
				expect(homeP.footer.header.getText()).toEqual(browser.params.user.authentication.language.header.myAccount);
				expect(homeP.footer.aboutLink.getText()).toEqual(browser.params.user.authentication.language.menu.about);
			//	expect(homeP.footer.fagsLink.getText()).toEqual(browser.params.user.authentication.language.menu.faqs);
			//	expect(homeP.footer.supportLink.getText()).toEqual(browser.params.user.authentication.language.menu.support);
			...
			else if (browser.params.target === 'remote'){
				if ( browser.mobile )
				{
...
//							});
					homeP.footer.language.getText().then(function(text)
							{ 
						expect( text.replace(/>/g,"").trim()).toBe('Language : English'); 
							});
			...
			if (browser.deviceName === 'Edge'){
				expect(homeP.footer.language.getText()).toMatch('\s*言語 : 日本\s*');
				expect(homeP.footer.header.getText()).toEqual(browser.params.user.authentication.language.header.myAccount);
				expect(homeP.footer.aboutLink.getText()).toEqual(browser.params.user.authentication.language.menu.about);
	//			expect(homeP.footer.fagsLink.getText()).toEqual(browser.params.user.authentication.language.menu.faqs);
	//			expect(homeP.footer.supportLink.getText()).toEqual(browser.params.user.authentication.language.menu.support);
...
//							});
					homeP.footer.language.getText().then(function(text)
							{ 
						expect( text.replace(/>/g,"").trim()).toBe('言語 : 日本'); 
							});
					homeP.footer.login.getText().then(function(text)
							{ 
						expect( text.replace(/>/g,"").trim()).toBe(browser.params.user.authentication.language.header.logout); 
				...
				expect(homeP.footer.language.getText()).toEqual('言語 : 日本');
				expect(homeP.footer.header.getText()).toEqual(browser.params.user.authentication.language.header.myAccount);
				expect(homeP.footer.aboutLink.getText()).toEqual(browser.params.user.authentication.language.menu.about);
		//	    expect(homeP.footer.fagsLink.getText()).toEqual(browser.params.user.authentication.language.menu.faqs);
		//		expect(homeP.footer.supportLink.getText()).toEqual(browser.params.user.authentication.language.menu.support);
		...
		//		expect(homeP.footer.accessibilityLink.getText()).toEqual(browser.params.user.authentication.language.menu.accessibility);
			...
			if (browser.deviceName === 'Edge'){
				expect(homeP.footer.language.getText()).toMatch('\s*Idioma : Español\s*');
				expect(homeP.footer.header.getText()).toEqual(browser.params.user.authentication.language.header.myAccount);
				expect(homeP.footer.aboutLink.getText()).toEqual(browser.params.user.authentication.language.menu.about);
		//		expect(homeP.footer.fagsLink.getText()).toEqual(browser.params.user.authentication.language.menu.faqs);
		//		expect(homeP.footer.supportLink.getText()).toEqual(browser.params.user.authentication.language.menu.support);
...
//							});
					homeP.footer.language.getText().then(function(text)
							{ 
						expect( text.replace(/>/g,"").trim()).toBe('Idioma : Español'); 
							});
					homeP.footer.login.getText().then(function(text)
							{ 
						expect( text.replace(/>/g,"").trim()).toBe(browser.params.user.authentication.language.header.logout); 
				...
				expect(homeP.footer.language.getText()).toEqual('Idioma : Español');
				expect(homeP.footer.header.getText()).toEqual(browser.params.user.authentication.language.header.myAccount);
				expect(homeP.footer.aboutLink.getText()).toEqual(browser.params.user.authentication.language.menu.about);
		//		expect(homeP.footer.fagsLink.getText()).toEqual(browser.params.user.authentication.language.menu.faqs);
		//		expect(homeP.footer.supportLink.getText()).toEqual(browser.params.user.authentication.language.menu.support);
...
//	it(browser.tc_desc('UIDS-1572 TC9 (1) Click on close button in logout (2) It should redirect to my account menu'), function() {
//
//		browser.indirectClick(homeP.footer.login);
//		
//		//		if (browser.params.target === 'remote'){
...
//	});
	...
	function verifyText() {
		if( !browser.mobile ){
			...
			expect(homeP.footer.aboutLink.getText()).toEqual(browser.params.user.authentication.language.footer.about);
	...
	//		expect(homeP.footer.supportLink.getText()).toEqual(browser.params.user.authentication.language.footer.support);
			expect(homeP.footer.privacyLink.getText()).toEqual(browser.params.user.authentication.language.footer.privacy);
	...
	//		expect(homeP.footer.accessibilityLink.getText()).toEqual(browser.params.user.authentication.language.footer.accessibility);
			...
			expect(myactpage.myAccount.myAccountWelcome.getText()).toEqual(browser.params.user.authentication.language.accountHome.header.toUpperCase()+" FIRSTNAME");
			...
			expect( replaceWithUpperCase(homeP.footer.header.getText())).toBe(browser.params.user.authentication.language.header.myAccount.toUpperCase()); 
			   expect( replaceText(homeP.footer.aboutLink.getText())).toBe(browser.params.user.authentication.language.footer.about);
	...
	//		   expect( replaceText(homeP.footer.supportLink.getText())).toBe(browser.params.user.authentication.language.footer.support);
			   expect( replaceText(homeP.footer.privacyLink.getText())).toBe(browser.params.user.authentication.language.footer.privacy); 
	...
	//		   expect( replaceText(homeP.footer.accessibilityLink.getText())).toBe(browser.params.user.authentication.language.footer.accessibility); 
			   ...
			   expect( replaceText(myactpage.myAccount.myAccountWelcome.getText())).toBe(browser.params.user.authentication.language.accountHome.header.toUpperCase()+" FIRSTNAME");
