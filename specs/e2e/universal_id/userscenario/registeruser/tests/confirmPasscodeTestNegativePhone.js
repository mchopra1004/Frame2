...
describe('UIDS-845 Add "Second Factor Method" Confirm Pass-code Page ----- ', function() {
    ...
    it(browser.tc_desc('(1) Enter the locked phone device again as 2FA (2) It should give a validation'), function() {
    ...
    it(browser.tc_desc('Enter a new phone as 2FA after device is locked'), function() {
        actpage.registerPhone.phoneNumberEditBox.clear();
    ...
    it(browser.tc_desc('Generate OTP for the second factor phone after earlier one is locked'), function() {
    ...
    it(browser.tc_desc('UIDS-1115 TC17 Enter Pass code for the new phone added as second factor after the previous one is locked'), function() {
